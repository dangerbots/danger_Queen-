...
from dreamAngel import telethn as bot
from dreamAngel.modules.urluploader import download_file
from dreamAngel.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @ThedreamAngelBot",
            )
        except Exception as e:
            traceback.print_exc()
