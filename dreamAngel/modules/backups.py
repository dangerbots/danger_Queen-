...
# from dreamAngel.modules.sql import warns_sql as warnssql
import dreamAngel.modules.sql.blacklist_sql as blacklistsql

# from dreamAngel.modules.sql import cust_filters_sql as filtersql
# import dreamAngel.modules.sql.welcome_sql as welcsql
import dreamAngel.modules.sql.locks_sql as locksql
import dreamAngel.modules.sql.notes_sql as sql

# from dreamAngel.modules.rules import get_rules
import dreamAngel.modules.sql.rules_sql as rulessql
from dreamAngel import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
from dreamAngel.__main__ import DATA_IMPORT
from dreamAngel.modules.connection import connected
from dreamAngel.modules.helper_funcs.alternate import typing_action
from dreamAngel.modules.helper_funcs.chat_status import user_admin
from dreamAngel.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    f = open("dreamAngel{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("dreamAngel{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `dreamAngel-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("dreamAngel{}.backup".format(chat_id))  # Cleaning file
